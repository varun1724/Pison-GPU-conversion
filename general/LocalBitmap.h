...
class LocalBitmap : public Bitmap {
  ...
  private:
    ...
    unsigned long long *mEscapeBitmap, *mStrBitmap, *mColonBitmap, *mCommaBitmap, *mLbracketBitmap, *mRbracketBitmap, *mLbraceBitmap, *mRbraceBitmap;
    ...
    unsigned long long mStartInStrBitmap;
    // marks whether current chunk ends inside string or not
    unsigned long long mEndInStrBitmap;
    ...
    unsigned long long *mNegLevColonBitmap[MAX_LEVEL];
    unsigned long long *mNegLevCommaBitmap[MAX_LEVEL];
    ...
    unsigned long long *mFinalLevColonBitmap[MAX_LEVEL];
    unsigned long long *mFinalLevCommaBitmap[MAX_LEVEL];
    ...
    long long mStartWordId;
    long long mEndWordId;
